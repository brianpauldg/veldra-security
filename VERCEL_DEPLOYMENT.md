# Bloom Metabolics — Vercel Deployment Guide

This guide walks you through deploying Bloom Metabolics to Vercel with all necessary environment variables and webhook configuration.
...
git init
git add .
git commit -m "Initial commit: Bloom Metabolics with security and landing page"
```
...
NEXT_PUBLIC_APP_URL=https://bloommetabolics.vercel.app  (or your custom domain)
...
1. Open your Vercel deployment URL (e.g., https://bloommetabolics.vercel.app)
...
2. Add your domain (e.g., `app.bloommetabolics.io`)
...
Your Bloom Metabolics app is now live! 🚀
