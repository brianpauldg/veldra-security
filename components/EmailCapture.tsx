      ...
      <div className="flex gap-2">
        <div className="flex-1">
          <input
            ...
            {...register('email')}
            className="w-full px-5 py-3 rounded-full border border-[#1a1814] text-[14px] text-[#d8cfbe] placeholder:text-[#8a8268] focus:outline-none focus:ring-2 focus:ring-[#8a8268]/30 focus:border-transparent transition-all"
          />
          {errors.email && (
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#020202] text-white text-[14px] font-medium hover:bg-[#1a1814] transition-all disabled:opacity-50 flex-shrink-0"
        >
          Subscribe
