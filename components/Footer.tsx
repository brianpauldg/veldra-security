      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="border-t border-[#1a1814] py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[11px] text-[#2a2620] max-w-2xl text-center md:text-right leading-relaxed font-light">
            Bloom Metabolics is a California-based telehealth membership practice launching July 15, 2026. All prescriptions, upon launch, require evaluation by a U.S.-licensed physician. Medication availability varies by state. Individual results vary.
          </p>
        </div>
      </div>
    </footer>
