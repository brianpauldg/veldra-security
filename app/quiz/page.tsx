          ...
          <AnimatePresence mode="wait">
            ...
            {step === 'intro' && (
              ...
              >
                <div className="bg-[#050404] rounded-2xl p-8 mb-8">
                  <h2 className="text-display-sm text-[#d8cfbe] mb-4">How It Works</h2>
                  <div className="grid gap-4 text-left max-w-md mx-auto">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-3">
                        <div className="w-7 h-7 rounded-full bg-[#020202] text-white text-[13px] font-semibold flex items-center justify-center flex-shrink-0 mt-0.5">
                          {i + 1}
                        </div>
            ...
            {step === 'quiz' && (
              ...
              >
                ...
                <h2 className="text-display-sm text-[#d8cfbe] mb-8">
            ...
            {step === 'email' && (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-[#0d0c0a] flex items-center justify-center mx-auto mb-6">
                  <Activity className="w-8 h-8 text-[#d8cfbe]" />
                </div>
                ...
                <form onSubmit={handleEmailSubmit} className="max-w-sm mx-auto">
                  <input
                    ...
                    className="w-full px-5 py-3.5 rounded-xl border border-[#1a1814] text-[15px] text-[#d8cfbe] placeholder:text-[#8a8268] focus:outline-none focus:ring-2 focus:ring-[#8a8268]/30 mb-2"
                  />
                  {emailError && (
                  ...
                  <button
                    type="submit"
                    className="w-full mt-2 inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#020202] text-white text-[15px] font-semibold hover:bg-[#0d0c0a] transition-all"
                  >
                    See My Results
                    <ArrowRight className="w-4 h-4" />
                  </button>
            ...
            {step === 'results' && (
              ...
              >
                ...
                <div className="bg-[#050404] rounded-2xl p-6 mb-8">
                  <h3 className="text-[14px] font-semibold text-[#d8cfbe] mb-4 uppercase tracking-wider">Your Symptom Profile</h3>
                  <div className="grid gap-3">
                    {questions.map((q, i) => {
                      ...
                      return (
                        <div key={q.id} className="flex items-center justify-between">
                          <span className="text-[14px] text-[#8a8268]">{q.question.replace(/\?$/, '').substring(0, 50)}...</span>
