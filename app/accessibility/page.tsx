      ...
      <section className="bg-[#020202] py-16 lg:py-20">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <div className="space-y-8 text-[15px] leading-relaxed text-[#d8cfbe]">
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>Our Commitment</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>Compliance Target</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>Known Issues</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>Contact Us</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>Third-Party Content</h2>
