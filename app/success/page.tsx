...
export default function SuccessPage() {
  return (
    <>
      <section className="bg-[#020202] py-24 lg:py-32">
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <h2 className="text-display-sm text-[#d8cfbe] text-center mb-12">What happens next</h2>
            ...
            {[
              ...
              <div key={i} className="flex gap-6">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-xl bg-[#0d0c0a] flex items-center justify-center text-[#8a8268]">
                    {step.icon}
                  </div>
                </div>
                <div>
                  <h3 className="text-headline text-[#d8cfbe] mb-1">{step.title}</h3>
                  <p className="text-[14px] text-[#8a8268] leading-relaxed mb-1">{step.desc}</p>
                  <span className="text-[12px] font-medium text-[#8a8268]">{step.time}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 text-center">
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-[#020202] text-white text-[14px] font-medium hover:bg-[#0d0c0a] transition-all"
            >
