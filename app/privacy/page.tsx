      ...
      <section className="bg-[#020202] py-16 lg:py-20">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <div className="space-y-8 text-[15px] leading-relaxed text-[#d8cfbe]">
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>1. Introduction</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>2. Information We Collect</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>3. How We Use Your Information</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>4. How We Protect Your Information</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>5. Your Rights Under HIPAA</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>6. Breach Notification</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>7. SMS/Text Messaging Communications</h2>

              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>What Information We Collect</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>How We Use Your Phone Number</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>Information Sharing</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>Message Frequency and Rates</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>How to Opt Out</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>How to Get Help</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>HIPAA Compliance</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>Carrier Disclaimer</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>SMS Data Retention</h3>
              ...
              <h3 className="text-[1.1rem] font-light text-white mb-3 mt-6" style={{ fontFamily: 'var(--font-display)' }}>Changes to SMS Practices</h3>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>8. Complaints</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>9. Cookies and Analytics</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>10. Changes to This Notice</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>11. Your Rights Under California Law (CCPA/CPRA)</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>12. Sensitive Personal Information (CPRA)</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>13. California Confidentiality of Medical Information Act (CMIA)</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>14. Third-Party Service Providers</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>15. We Do Not Sell Personal Information</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>16. Children&apos;s Privacy</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>17. Data Retention</h2>
            ...
            <div>
              <h2 className="text-[1.5rem] font-light text-white mb-4" style={{ fontFamily: 'var(--font-display)' }}>18. Contact Information</h2>
