          ...
          <AnimatePresence mode="wait">
            {step === 'intro' && (
              ...
              >
                <div className="bg-graphite-50 rounded-2xl p-8 mb-8">
                  <h2 className="text-display-sm text-graphite-950 mb-4">What You&apos;ll Learn</h2>
            ...
            {step === 'quiz' && (
              ...
              >
                ...
                <h2 className="text-display-sm text-graphite-950 mb-2">
                  {questions[current].question}
                </h2>
                {questions[current].subtitle && (
                  <p className="text-[14px] text-graphite-500 mb-8">{questions[current].subtitle}</p>
                )}
            ...
            {step === 'capture' && (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-graphite-100 flex items-center justify-center mx-auto mb-6">
                  <Scale className="w-8 h-8 text-graphite-700" />
                </div>
                ...
                <form onSubmit={handleSubmit} className="max-w-sm mx-auto space-y-3">
                  <input
                    ...
                    className="w-full px-5 py-3.5 rounded-xl border border-graphite-200 text-[15px] text-graphite-900 placeholder:text-graphite-400 focus:outline-none focus:ring-2 focus:ring-graphite-300"
                  />
                  <input
                    type="tel"
                    value={phone}
                  ...
                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-graphite-950 text-white text-[15px] font-semibold hover:bg-graphite-800 transition-all"
                  >
                    See My Results
                    <ArrowRight className="w-4 h-4" />
                  </button>
              ...
              >
                <div className="text-center mb-10">
                  <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border mb-6 text-[13px] font-semibold ${
                    ...
                    'border-graphite-200 bg-graphite-50 text-graphite-600'
                  }`}>
                ...
                {tier !== 'unlikely' && (
                  <div className="bg-graphite-50 rounded-2xl p-6 mb-8">
                    <h3 className="text-[14px] font-semibold text-graphite-950 mb-3 uppercase tracking-wider">What Happens Next</h3>
                    <div className="grid gap-3">
                      {[
                        ...
                        <div key={i} className="flex items-start gap-3">
                          <div className="w-6 h-6 rounded-full bg-graphite-950 text-white text-[12px] font-semibold flex items-center justify-center flex-shrink-0 mt-0.5">
                            {i + 1}
                          </div>
                          <p className="text-[14px] text-graphite-600">{item}</p>
                        </div>
                      ))}
                    </div>
                  </div>
