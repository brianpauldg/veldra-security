...
export const SEED_ENCOUNTERS: Encounter[] = [
  { id: 'enc_001', patientId: 'pat_001', type: 'follow_up', date: daysAgo(14), providerId: 'usr_doc_001', providerName: 'Dr. Martinez', assessment: 'Patient well-optimized on TRT. Labs excellent. No side effects.', plan: 'Continue current protocol. Next labs in 90 days.', followUpDate: daysFromNow(76) },
  { id: 'enc_002', patientId: 'pat_004', type: 'follow_up', date: daysAgo(90), providerId: 'usr_doc_001', providerName: 'Dr. Martinez', assessment: 'Hematocrit trending up. Adherence declining. Patient reports fatigue despite adequate T levels.', plan: 'Order stat CBC. Discuss phlebotomy if HCT >52. Explore adherence barriers.', followUpDate: daysAgo(30) },
  { id: 'enc_003', patientId: 'pat_003', type: 'follow_up', date: daysAgo(7), providerId: 'usr_doc_001', providerName: 'Dr. Martinez', assessment: 'New start TRT responding well. T 620 at 8 weeks. No side effects. Mood and energy improving.', plan: 'Continue. Recheck at 12 weeks.', followUpDate: daysFromNow(83) },
  { id: 'enc_004', patientId: 'pat_006', type: 'follow_up', date: daysAgo(14), providerId: 'usr_doc_001', providerName: 'Dr. Martinez', assessment: 'Semaglutide 1.0mg weekly. Down 18 lbs in 10 weeks. Mild nausea first 2 weeks, resolved.', plan: 'Continue current dose. Recheck A1c and metabolic panel at 12 weeks.', followUpDate: daysFromNow(14) },
  { id: 'enc_005', patientId: 'pat_013', type: 'initial_consult', date: daysAgo(3), providerId: 'usr_doc_001', providerName: 'Dr. Martinez', chiefComplaint: 'Low energy, decreased libido, difficulty with body composition', assessment: 'Baseline labs: Total T 245, Free T 6.2. Symptomatic hypogonadism. Candidate for TRT.', plan: 'Start Testosterone Cypionate 150mg/wk. Baseline CBC, PSA, lipids, CMP ordered. Follow-up in 6 weeks.', followUpDate: daysFromNow(39) },
]
